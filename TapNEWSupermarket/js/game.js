...
function share(action){
	...
	if( action == 'twitter' ) {
		shareurl = 'https://zillakgames.com/'+loc+'&text='+text;
	}else if( action == 'facebook' ){
		shareurl = 'https://zillakgames.com/'+encodeURIComponent(loc+'share.php?desc='+text+'&title='+title+'&url='+loc+'&thumb='+loc+'share.jpg&width=590&height=300');
	}else if( action == 'google' ){
		shareurl = 'https://zillakgames.com/'+loc;
